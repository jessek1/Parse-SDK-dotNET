    ...
    public static partial class ParseClient
    {
        ...
        public struct Configuration
        {
            ...
            public interface IStorageConfiguration
            {
                ...
                string PersistentStorageDir { get; }
            }
            ...
            public struct MetadataBasedStorageConfiguration : IStorageConfiguration
            {
                ...
                public static MetadataBasedStorageConfiguration NoCompanyInferred { get; } = new MetadataBasedStorageConfiguration { CompanyName = Assembly.GetCallingAssembly().GetName().Name, ProductName = String.Empty };
                ...
                public string PersistentStorageDir { get; set; }
        ...
        {
            //Debug.WriteLine("ParseClient::Initialize - config" + Newtonsoft.Json.JsonConvert.SerializeObject(configuration));
            lock (mutex)
            {
                ...
                switch (configuration.VersionInfo)
                {
                    ...
                    case Configuration.VersionInformation info when !info.IsDefault:
                        configuration.VersionInfo = new Configuration.VersionInformation { BuildVersion = info.BuildVersion, OSVersion = info.OSVersion, DisplayVersion = info.DisplayVersion/*DisplayVersion = Configuration.VersionInformation.Inferred.DisplayVersion*/ };
                        break;
                    default:
                ...
                {
                    case Configuration.IStorageConfiguration controller when !(controller is null):
                        Debug.WriteLine("ParseClient::Initialize - configuration.StorageConfiguration = 0");
                        break;
                    default:
                        Debug.WriteLine("ParseClient::Initialize - configuration.StorageConfiguration = NoCompanyInferred");
                        configuration.StorageConfiguration = Configuration.MetadataBasedStorageConfiguration.NoCompanyInferred;
                        break;
                }

                CurrentConfiguration = configuration;
                Debug.WriteLine("ParseClient::Initialize - persistentStorageDir: "+ configuration.StorageConfiguration.PersistentStorageDir);
